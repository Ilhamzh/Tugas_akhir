...
public class TambahMatkul extends javax.swing.JFrame {
    ...
    public TambahMatkul(String userId, String userName) {
        this.userId = userId;
    ...
    private void setupNavListeners() {
        ...
        // Tombol Aksi
        jButton2.addActionListener(e -> tambahMatkulAction());
        jButton3.addActionListener(e -> hapusMatkulAction());
        
        // Logout
        jButton1.addActionListener(e -> navController.navigate("LogOut"));
    }
    
    private void tambahMatkulAction() {
        JOptionPane.showMessageDialog(this, "Fungsi Tambah Mata Kuliah belum diimplementasikan.", "Info", JOptionPane.INFORMATION_MESSAGE);
    }
    
    private void hapusMatkulAction() {
        JOptionPane.showMessageDialog(this, "Fungsi Hapus Mata Kuliah belum diimplementasikan.", "Info", JOptionPane.INFORMATION_MESSAGE);
    }
