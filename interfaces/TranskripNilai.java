...
public class TranskripNilai extends javax.swing.JFrame {
    ...
    public TranskripNilai(String userId, String userName) {
        this.userId = userId;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Matkul", "Nama Matkul", "SKS", "Nilai", "AK", "Tahun Ambil"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TranskripNilai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
