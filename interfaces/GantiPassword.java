...
public class GantiPassword extends javax.swing.JFrame {
   ...
   public GantiPassword() {
        ...
        navController = new NavController(this, "Mahasiswa", userId, userName);
        setupListeners();
    }
    
    
    public GantiPassword(String userId, String userName) {
        this.userId = userId;
        this.userName = userName;
        initComponents();
        
        String role = (userId != null && userId.length() > 5) ? "Mahasiswa" : "Dosen";
        navController = new NavController(this, role, userId, userName);
        setupListeners();
    ...
    private void gantiPasswordAction() {
        ...
        if (newPassword.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Password baru tidak boleh kosong.", "Peringatan", JOptionPane.WARNING_MESSAGE);
            return;
        }
