...
public class Bimbingan extends javax.swing.JFrame {
    ...
    public Bimbingan() {
        ...
        this("672024116", "Yanto Balap", "D001");
    }

    public Bimbingan(String nimUser, String namaUser, String nidDosen) {
        initComponents();
        this.nimUser = nimUser;
        this.namaUser = namaUser;
        this.nidDosen = nidDosen;
    ...
    private void kirimPesanBimbingan() {
        String pesan = jTextArea1.getText().trim();
        ...
        bimbinganDAO.kirimPesan(nimUser, nidDosen, pesan);

        JOptionPane.showMessageDialog(this,
                "Pesan bimbingan berhasil dikirim.",
                "Sukses",
    ...
    private void initComponents() {
        ...
        jButton4.setText("Registrasi Ulang");
        ...
        jButton10.setText("Registrasi Matkul");
        ...
        jLabel2.setText("NINA SETIYAWATI");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bimbingan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
